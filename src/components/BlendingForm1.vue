      ...
      <v-card-text>
        <v-form>
          <v-container>
            <v-row>
              <v-col cols="12" md="2">
                <v-subheader class="red--text font-weight-bold"
                  >Mieszanina A</v-subheader
                >
              </v-col>
            ...
            <v-row>
              <v-col cols="12" md="2">
                <v-subheader class="blue--text font-weight-bold"
                  >Mieszanina B</v-subheader
                >
              </v-col>
            ...
            <v-row>
              <v-col cols="12" md="2">
                <v-subheader class="green--text font-weight-bold"
                  >Mieszanina C</v-subheader
                >
              </v-col>
...
export default {
  ...
  methods: {
    mieszanie() {
      this.result_mieszanie = parseFloat(
        (this.objetosc_a * this.stezenie_a +
          this.objetosc_b * this.stezenie_b +
          this.objetosc_c * this.stezenie_c) /
          (this.objetosc_a + this.objetosc_b + this.objetosc_c)
      );
      return this.result_mieszanie || 0;
    },
    objetosc_all() {
      this.result_objetosc = parseFloat(
        this.objetosc_a + this.objetosc_b + this.objetosc_c
      );
