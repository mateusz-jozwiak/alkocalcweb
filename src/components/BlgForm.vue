<template>
    <div>
        <v-card v-show="!isShown" class="mx-2 my-2" max-width="auto" center>
            ...
            <v-card-title>Obliczenia nastawu
                <template>
                        ...
                        <v-dialog v-model="dialog" width="500">
                            ...
                            <v-card>
                                <v-card-title class="text-h5 dark lighten-2">
                                    Obliczenia związane z nastawem<v-icon color="primary" class="ml-2">mdi-information</v-icon>
                                </v-card-title>
            ...
            <v-card-title>Obliczenia °Blg<template>
                    <div class="text-center">
                        <v-dialog v-model="dialog2" width="500">
                            ...
                            <v-card>
                                <v-card-title class="text-h5 dark lighten-2">
                                    Obliczenia °Blg <v-icon color="primary" class="ml-2">mdi-information</v-icon>
                                </v-card-title>
